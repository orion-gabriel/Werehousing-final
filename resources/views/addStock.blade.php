...
<div class="container mx-auto p-4">
    <h2 class="text-2xl mb-2 text-gray-800 font-semibold">Add Stock</h2>
    ...
    <form action="{{ route('processAddStock') }}" method="POST">
        ...
        <button type="submit" class="form-control text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Add Stock</button>
