                        ...
                        <div>
                            ...
                            <div class="grid md:grid-cols-2 md:gap-6">
                                <div class="z-0 w-full my-3 group">
                                    <label for="type" class="columns-2 justify-start text-sm font-medium leading-6 text-gray-900">Kategori Produk</label>
                            ...
                            <label class="form-control block mb-2 text-sm font-medium text-gray-900" for="itempic">Gambar Produk</label>
