        ...
        <div class="md:w-2/3 sm:w-full h-screen items-center justify-center py-12 lg:px-9 sm:px-9">
            ...
            <div class="mt-10 sm:mx-auto sm:w-screen sm:max-w-sm">
                <form action="{{ route('login') }}" method="POST">
                    @csrf
                <div>
                    <label for="email" class="block lg:text-sm sm:text-xs font-medium leading-6 text-gray-900">Email address</label>
                    <div class="mt-2">
                ...
                <div>
                    ...
                    <div class="text-sm mt-2">
                            <a href="#" class="font-semibold text-indigo-600 hover:text-indigo-500 text-sm">Forgot password?</a>
                    </div>
                </div>
                <br>
                <div>
